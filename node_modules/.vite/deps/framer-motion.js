...
function useFocusGesture({ whileFocus, visualElement }) {
  ...
  const onBlur = (0, import_react19.useCallback)(() => {
...
function useHoverGesture({ onHoverStart, onHoverEnd, whileHover, visualElement }) {
  usePointerEvent(visualElement, "pointerenter", (0, import_react20.useMemo)(() => {
  ...
  usePointerEvent(visualElement, "pointerleave", (0, import_react20.useMemo)(() => {
...
function useTapGesture({ onTap, onTapStart, onTapCancel, whileTap, visualElement, ...props }) {
  ...
  const isPressing = (0, import_react22.useRef)(false);
  const cancelPointerEndListeners = (0, import_react22.useRef)(null);
  const eventOptions = {
  ...
  const startPress = (0, import_react22.useCallback)((event, info) => {
    var _a;
    removePointerEndListener();
...
function useViewport({ visualElement, whileInView, onViewportEnter, onViewportLeave, viewport = {} }) {
  const state = (0, import_react23.useRef)({
...
var animations = {
  animation: makeRenderlessComponent(({ visualElement, animate: animate4 }) => {
    ...
    if (isAnimationControls(animate4)) {
      (0, import_react25.useEffect)(() => animate4.subscribe(visualElement), [animate4]);
    }
  }),
...
function useDrag(props) {
  ...
  (0, import_react26.useEffect)(() => groupDragControls && groupDragControls.subscribe(dragControls), [dragControls, groupDragControls]);
  (0, import_react26.useEffect)(() => dragControls.addListeners(), [dragControls]);
}
...
function usePanGesture({ onPan, onPanStart, onPanEnd, onPanSessionStart, visualElement }) {
  ...
  const panSession = (0, import_react27.useRef)(null);
  const { transformPagePoint } = (0, import_react27.useContext)(MotionConfigContext);
  const handlers = {
  ...
  loadFeatures({ children, ...renderedProps }, isStrict, preloadedFeatures, projectionId, ProjectionNodeConstructor, initialLayoutGroupConfig) {
    ...
    for (let i = 0; i < numFeatures; i++) {
      ...
      if (isEnabled(renderedProps) && Component2) {
        features.push((0, import_react28.createElement)(Component2, {
          key: name,
          ...renderedProps,
          visualElement: this
        }));
...
function MeasureLayout(props) {
  ...
  return import_react29.default.createElement(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react29.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react31.useCallback)(() => sync.postRender(forceRender), [forceRender]);
...
var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode }) => {
  ...
  const id4 = (0, import_react33.useId)();
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  return React4.createElement(React4.Fragment, null, exiting.size ? childrenToRender : childrenToRender.map((child) => (0, import_react34.cloneElement)(child)));
};
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  config = { ...(0, import_react37.useContext)(MotionConfigContext), ...config };
...
function useMotionValue(initial) {
  ...
  if (isStatic) {
    ...
    (0, import_react41.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
function useScroll({ container, target, layoutEffect = true, ...options } = {}) {
  ...
  const useLifecycleEffect = layoutEffect ? useIsomorphicLayoutEffect : import_react45.useEffect;
  useLifecycleEffect(() => {
...
function useAnimationFrame(callback) {
  const initialTimestamp = (0, import_react46.useRef)(0);
...
function useMotionValueEvent(value, event, callback) {
  (0, import_react47.useInsertionEffect)(() => value.on(event, callback), [value, event, callback]);
}
...
function useReducedMotion() {
  ...
  const [shouldReduceMotion] = (0, import_react48.useState)(prefersReducedMotion.current);
  if (true) {
...
function useReducedMotionConfig() {
  ...
  const { reducedMotion } = (0, import_react49.useContext)(MotionConfigContext);
...
function useCycle(...items) {
  const index2 = (0, import_react50.useRef)(0);
  const [item, setItem] = (0, import_react50.useState)(items[index2.current]);
  const runCycle = (0, import_react50.useCallback)(
    (next) => {
...
function useInView(ref, { root, margin, amount, once = false } = {}) {
  const [isInView, setInView] = (0, import_react51.useState)(false);
...
function useAnimatedState(initialState) {
  const [animationState, setAnimationState] = (0, import_react53.useState)(initialState);
